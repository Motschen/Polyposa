...
public class PolymerStairsBlock extends StairsBlock implements FactoryBlock {
    private final Identifier id;
    private final Block template;

    public PolymerStairsBlock(BlockState baseBlockState, Settings settings, Block template) {
