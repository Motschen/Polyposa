...
public class PolymerFenceGateBlock extends FenceGateBlock implements FactoryBlock {
    private final Identifier id;
    private final Block template;

    public PolymerFenceGateBlock(WoodType type, Settings settings, Block template) {
        super(type, settings);
    ...
    public @Nullable ElementHolder createElementHolder(ServerWorld world, BlockPos pos, BlockState initialBlockState) {
        return new PolymerFenceGateBlock.Model(initialBlockState, id);
    }
