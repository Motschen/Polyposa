...
public class PolymerDoorBlock extends DoorBlock implements FactoryBlock, PolymerTexturedBlock {
    ...
    public PolymerDoorBlock(Settings settings) {
        ...
        MODEL_TOP_RIGHT = ItemDisplayElementUtil.getModel(Identifier.of(id.getNamespace(), "block/%s_top_left".formatted(id.getPath())));
        MODEL_TOP_LEFT = ItemDisplayElementUtil.getModel(Identifier.of(id.getNamespace(), "block/%s_top_right".formatted(id.getPath())));
        MODEL_BOTTOM_RIGHT = ItemDisplayElementUtil.getModel(Identifier.of(id.getNamespace(), "block/%s_bottom_left".formatted(id.getPath())));
        MODEL_BOTTOM_LEFT = ItemDisplayElementUtil.getModel(Identifier.of(id.getNamespace(), "block/%s_bottom_right".formatted(id.getPath())));
    }
    ...
    public static final class Model extends BlockModel {
        ...
        private void updateStatePos(BlockState state) {
            ...
            if(state.get(PolymerDoorBlock.HINGE).equals(DoorHinge.LEFT)){
                rotation += open ? 90 : 0;
            } else {
                rotation += open ? 270 : 0;
            }
        ...
        private void updateItem(BlockState state) {
            PolymerDoorBlock door = (PolymerDoorBlock) state.getBlock();
