...
public class PolymerPressurePlate extends PressurePlateBlock implements FactoryBlock {
    private final Identifier id;
    private final Block template;

    public PolymerPressurePlate(BlockSetType blockSet, Settings settings, Block template) {
