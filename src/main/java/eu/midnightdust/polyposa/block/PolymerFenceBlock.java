...
public class PolymerFenceBlock extends FenceBlock implements FactoryBlock {
    private final Identifier id;
    private final Block template;

    public PolymerFenceBlock(Settings settings, Block template) {
        super(settings);
    ...
    public @Nullable ElementHolder createElementHolder(ServerWorld world, BlockPos pos, BlockState initialBlockState) {
        return new PolymerFenceBlock.Model(initialBlockState, id);
    }
