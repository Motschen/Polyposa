...
public class PolymerButtonBlock extends ButtonBlock implements FactoryBlock {
    ...
    public PolymerButtonBlock(BlockSetType blockSetType, int pressTicks, Settings settings, Block template) {
    ...
    public @Nullable ElementHolder createElementHolder(ServerWorld world, BlockPos pos, BlockState initialBlockState) {
        return new PolymerButtonBlock.Model(initialBlockState, id);
    }
